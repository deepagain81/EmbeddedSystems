...
#define NUM_TX_BUFS (1) // reserve one buffer for TX
...
#define RX_BUFFER_ID (15) //if 15, use FIFO
...
int main(void){
	...
	configECAN1();
	CHANGE_MODE_ECAN1(ECAN_MODE_LOOPBACK); // loopback to ourselves for the test
